...
def get_device_with_most_free_memory():
    """
    Get the CUDA device with the most free video memory, if no GPU is available, return the CPU.
    """
...
class LlamaHelper:
    ...
    def _sample_greedy(self, logits):
        """
        Greedy sampling strategy to select the maximum value as the next token
        """

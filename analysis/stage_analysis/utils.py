...
def plot_ci_plus_heatmap(data, heat, labels, 
    ...
    """
    Plot heat maps with confidence intervals containing the mean and standard deviation of the data or confidence intervals for other methods
    """
...
def process_axis(ax, ylabel_font=13, xlabel_font=13):
    """
    Handles the appearance of the shaft, removing the top and right side borders
    """
...
def yaml_to_dict(yaml_file):
    """
    Converting YAML files to dictionaries
    """

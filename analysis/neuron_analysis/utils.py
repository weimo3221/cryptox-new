...
def plot_ci_plus_heatmap(data, heat, labels, 
    ...
    """
    Plotting heat maps with confidence intervals containing the mean and standard deviation of the data or confidence intervals for other methods
    """
...
def process_axis(ax, ylabel_font=13, xlabel_font=13):
    """
    Handles the appearance of the shaft, removing the top and right borders
    """
